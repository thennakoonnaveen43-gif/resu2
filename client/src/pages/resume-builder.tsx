...
import TemplateFifteen from "@/components/resume-templates/template-fifteen";
import TemplateSixteen from "@/components/resume-templates/template-sixteen";
...
export default function ResumeBuilder() {
  ...
  const renderTemplate = () => {
    ...
    switch (templateId) {
      ...
      case "15":
        return <TemplateFifteen {...props} />;
case "16":
        return <TemplateSixteen {...props} />;
